    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                float2 node_864 = i.uv0;
                float4 node_638 = _Time + _TimeEditor;
                clip((tex2D(_AlphaNoiseTexture,TRANSFORM_TEX(node_864.rg, _AlphaNoiseTexture)).r*(1.0/fmod((node_638.g*_AlphaVelocity),5.0))) - 0.5);
                i.normalDir = normalize(i.normalDir);
                float3x3 tangentTransform = float3x3( i.tangentDir, i.binormalDir, i.normalDir);
                float3 viewDirection = normalize(_WorldSpaceCameraPos.xyz - i.posWorld.xyz);
/////// Normals:
                float3 normalLocal = tex2D(_Normal,TRANSFORM_TEX(node_864.rg, _Normal)).rgb;
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float4 node_2 = tex2D(_Diffuse,TRANSFORM_TEX(node_864.rg, _Diffuse));
...
/// Final Color:
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_638 = _Time + _TimeEditor;
                clip((tex2D(_AlphaNoiseTexture,TRANSFORM_TEX(node_865.rg, _AlphaNoiseTexture)).r*(1.0/fmod((node_638.g*_AlphaVelocity),5.0))) - 0.5);
                i.normalDir = normalize(i.normalDir);
                float3x3 tangentTransform = float3x3( i.tangentDir, i.binormalDir, i.normalDir);
                float3 viewDirection = normalize(_WorldSpaceCameraPos.xyz - i.posWorld.xyz);
/////// Normals:
                float3 normalLocal = tex2D(_Normal,TRANSFORM_TEX(node_865.rg, _Normal)).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float4 node_2 = tex2D(_Diffuse,TRANSFORM_TEX(node_865.rg, _Diffuse));
                float3 specularColor = float3(node_2.a,node_2.a,node_2.a);
...
/// Final Color:
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_638 = _Time + _TimeEditor;
                clip((tex2D(_AlphaNoiseTexture,TRANSFORM_TEX(node_866.rg, _AlphaNoiseTexture)).r*(1.0/fmod((node_638.g*_AlphaVelocity),5.0))) - 0.5);
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                float2 node_867 = i.uv0;
                float4 node_638 = _Time + _TimeEditor;
                clip((tex2D(_AlphaNoiseTexture,TRANSFORM_TEX(node_867.rg, _AlphaNoiseTexture)).r*(1.0/fmod((node_638.g*_AlphaVelocity),5.0))) - 0.5);
