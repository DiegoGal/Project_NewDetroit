Shader "Custom/EnhancedBumpedSpecular"
{
	Properties 
	{
...
_Shininess("Shininess", Range(0.01,1) ) = 0.327
_SpecIntensity("_SpecIntensity", Float) = 10
...
float4 Multiply1=Tex2D0.aaaa * _SpecIntensity.xxxx;
