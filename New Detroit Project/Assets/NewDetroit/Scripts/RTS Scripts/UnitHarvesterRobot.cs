...
public class UnitHarvesterRobot : UnitHarvester
{
    ...
    public override void Awake ()
    {
        ...
        if (dummyMineralPack == null)
            dummyMineralPack = transform.FindChild("Bip001/Bip001 Pelvis/Bip001 Spine/Dummy_Cuerpo");
        if (dummyHand == null)
            dummyHand = transform.FindChild("Bip001/Bip001 Pelvis/Bip001 Spine/Bip001 Spine1/Bip001 Neck/Bip001 R Clavicle/Bip001 R UpperArm/Bip001 R Forearm/Bip001 R Hand/Bip001 R Finger1/Bip001 R Finger1Nub");
        ...
        if (dummyHead == null)
            dummyHead = transform.FindChild("Bip001/Bip001 Pelvis/Bip001 Spine/Bip001 Spine1/Bip001 Neck/Bip001 Head/Dummy_Cabeza");
    ...
    public override void Start ()
    {
        ...
        if (dummyHand)
        {
            ...
            peak = (GameObject)Instantiate
            (
                Resources.Load("Goblin Army/GoblinHarvesterBeak"),
