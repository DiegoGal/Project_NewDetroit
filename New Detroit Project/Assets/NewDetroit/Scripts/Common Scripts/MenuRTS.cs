...
public class MenuRTS : MonoBehaviour {
    ...
    public static readonly string SceneNameMenu = "MenuRTS";

    public static readonly string SceneNameGame = "PlayRTS";
