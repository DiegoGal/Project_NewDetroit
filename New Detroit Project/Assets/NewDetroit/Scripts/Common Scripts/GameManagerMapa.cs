...
public class GameManagerMapa : Photon.MonoBehaviour {

    public GameObject fogPlane; //The fog plane in the scene

    public GameObject redBase; // Red Lobsters Base

    public GameObject blueBase; // Robot Base
    ...
    public void Awake()
    {
        ...
        else
        {
            ...
            if (!joinned)
            {
                ...
                Camera.main.transform.position = new Vector3(97, 24, -124);
            ...
            else
            {
                ...
                Camera.main.transform.position = new Vector3(-89, 24, 65);
