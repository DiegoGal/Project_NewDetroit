...
/*SF_DATA;ver:0.25;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:3,uamb:True,mssp:True,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:True,rmgx:True,hqsc:True,hqlp:False,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0;n:type:ShaderForge.SFN_Final,id:0,x:32343,y:32843|diff-138-RGB,spec-145-OUT,gloss-146-OUT,normal-123-RGB,amspl-162-OUT;n:type:ShaderForge.SFN_Tex2d,id:123,x:32850,y:33122,ptlb:Normal,tex:bbab0a6f7bae9cf42bf057d8ee2755f6,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Tex2d,id:138,x:33229,y:32643,ptlb:Diffuse,tex:b66bceaf0cc0ace4e9bdc92f14bba709,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Slider,id:144,x:33009,y:33024,ptlb:Gloss,min:0,cur:0.6165418,max:1;n:type:ShaderForge.SFN_Slider,id:145,x:32866,y:32820,ptlb:Specular,min:0,cur:0.1855478,max:1;n:type:ShaderForge.SFN_Multiply,id:146,x:32850,y:32945|A-147-OUT,B-144-OUT;n:type:ShaderForge.SFN_Power,id:147,x:33022,y:32882|VAL-138-A,EXP-148-OUT;n:type:ShaderForge.SFN_Vector1,id:148,x:33207,y:32916,v1:2;n:type:ShaderForge.SFN_Cubemap,id:156,x:33040,y:33373,ptlb:Specular IBL,cube:f466cf7415226e046b096197eb7341aa,pvfc:0;n:type:ShaderForge.SFN_Multiply,id:162,x:32850,y:33373,cmnt:RGBM Decode|A-156-RGB,B-156-A,C-163-OUT;n:type:ShaderForge.SFN_Vector1,id:163,x:33040,y:33527,v1:4;proporder:123-138-144-145-156;pass:END;sub:END;*/

Shader "Shader Forge/Floor Tiles" {
    Properties {
...
/////// Normals:
                float2 node_194 = i.uv0;
                float3 normalLocal = UnpackNormal(tex2D(_Normal,TRANSFORM_TEX(node_194.rg, _Normal))).rgb;
...
///////// Gloss:
                float4 node_138 = tex2D(_Diffuse,TRANSFORM_TEX(node_194.rg, _Diffuse));
...
/////// Normals:
                ...
                float3 normalLocal = UnpackNormal(tex2D(_Normal,TRANSFORM_TEX(node_195.rg, _Normal))).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
...
///////// Gloss:
                float4 node_138 = tex2D(_Diffuse,TRANSFORM_TEX(node_195.rg, _Diffuse));
                float gloss = exp2((pow(node_138.a,2.0)*_Gloss)*10.0+1.0);
////// Specular:
                NdotL = max(0.0, NdotL);
                float _Specular_var = _Specular;
