...
/*SF_DATA;ver:0.25;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:True,rmgx:True,hqsc:True,hqlp:False,blpr:1,bsrc:3,bdst:7,culm:0,dpts:2,wrdp:False,ufog:False,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.1280277,fgcg:0.1953466,fgcb:0.2352941,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0;n:type:ShaderForge.SFN_Final,id:1,x:32703,y:32721|diff-558-OUT,spec-2-A,normal-3-RGB,alpha-44-OUT,clip-164-R;n:type:ShaderForge.SFN_Tex2d,id:2,x:33506,y:32479,ptlb:Diffuse,tex:f4e68e511d6c5f44f8b0e01da2bd75ef,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:3,x:33066,y:32773,ptlb:Normal,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Color,id:12,x:33506,y:32722,ptlb:Alpha Color,c1:1,c2:0,c3:0,c4:1;n:type:ShaderForge.SFN_Time,id:25,x:33807,y:33251;n:type:ShaderForge.SFN_Divide,id:37,x:33195,y:33122|A-111-OUT,B-38-OUT;n:type:ShaderForge.SFN_Vector1,id:38,x:33477,y:33380,v1:5;n:type:ShaderForge.SFN_Add,id:44,x:33018,y:33218|A-37-OUT,B-46-OUT;n:type:ShaderForge.SFN_Vector1,id:46,x:33195,y:33324,v1:0.65;n:type:ShaderForge.SFN_Cos,id:111,x:33477,y:33219|IN-25-TTR;n:type:ShaderForge.SFN_TexCoord,id:162,x:33849,y:32908,uv:0;n:type:ShaderForge.SFN_Tex2d,id:164,x:33037,y:32963,ptlb:Alpha Noise Texture,tex:a2b573b0be2ba504bb1cabac4d218ac9,ntxv:0,isnm:False|UVIN-229-OUT;n:type:ShaderForge.SFN_Add,id:229,x:33427,y:32956|A-414-OUT,B-550-OUT;n:type:ShaderForge.SFN_Multiply,id:414,x:33652,y:32940|A-162-UVOUT,B-514-OUT;n:type:ShaderForge.SFN_ValueProperty,id:514,x:33849,y:33089,ptlb:Alpha Noise UV mult,v1:3;n:type:ShaderForge.SFN_Divide,id:550,x:33652,y:33089|A-25-T,B-552-OUT;n:type:ShaderForge.SFN_ValueProperty,id:552,x:33849,y:33171,ptlb:Alpha Noise Velocity,v1:10;n:type:ShaderForge.SFN_Add,id:558,x:33127,y:32533|A-2-RGB,B-12-RGB;n:type:ShaderForge.SFN_ValueProperty,id:571,x:33977,y:33217,ptlb:Alpha Noise UV mult_copy,v1:3;proporder:2-3-12-164-514-552;pass:END;sub:END;*/
...
/////// Normals:
                float2 node_587 = i.uv0;
                float3 normalLocal = tex2D(_Normal,TRANSFORM_TEX(node_587.rg, _Normal)).rgb;
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float4 node_2 = tex2D(_Diffuse,TRANSFORM_TEX(node_587.rg, _Diffuse));
...
/////// Normals:
                ...
                float3 normalLocal = tex2D(_Normal,TRANSFORM_TEX(node_588.rg, _Normal)).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float4 node_2 = tex2D(_Diffuse,TRANSFORM_TEX(node_588.rg, _Diffuse));
                float3 specularColor = float3(node_2.a,node_2.a,node_2.a);
